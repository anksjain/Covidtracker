...
class FAQ extends StatelessWidget {
      ...
      body: Container(
        child: ListView(
          children: <Widget>[
            ...
            faq("What should I do if I have COVID-19 symptoms and when should I seek medical care?",
            ...
            faq("Can COVID-19 be caught from a person who has no symptoms?",
            ...
            faq("How can we protect others and ourselves if we don't know who is infected?",
            ...
            faq("What should I do if I have come in close contact with someone who has COVID-19?",
            ...
            faq("Can children or adolescents catch COVID-19?",
            ...
            faq("How long does it take after exposure to COVID-19 to devlop symptoms?",
            ...
            faq("What is the connection between COVID-19 and animals?",
            ...
            faq("How long does the virus survive on surfaces?",
            ...
            faq("How to wash fruits and vegetables?",
            ...
            faq("Are antibiotics effective in preventing or treating COVID-19?",
            ...
            faq("Can I catch COVID-19 from the faces of someone with the disease?",
  ...
  faq(String title, String cont) {
    return Card(
      child: ExpansionTile(
        title: Text(title,style: TextStyle(fontWeight: FontWeight.bold),),
        trailing: FaIcon(FontAwesomeIcons.plusCircle),
        children: <Widget>[
          Container(
